...
class country_test(unittest.TestCase):
    ...
    def tearDown(self):
        self.ds.execute("DROP TABLE country")
        self.ds.execute("DROP TABLE city")
...
class country_test_pgsql(country_test):
    ...
    def tearDown(self):
        self.ds.execute("DROP TABLE country CASCADE")
        self.ds.execute("DROP TABLE city CASCADE")
...
class domain_and_email_test(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.ds.execute("DROP TABLE email")
