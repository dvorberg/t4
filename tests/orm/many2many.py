...
class many2many_test_pgsql(many2many_test):
    ...
    def tearDown(self):
        ...
        self.ds.execute("DROP TABLE mail_admin CASCADE")
        self.ds.execute("DROP TABLE mail_server CASCADE")
        self.ds.execute("DROP TABLE domain_to_mail_admin CASCADE")
        self.ds.execute("DROP TABLE mail_admin_to_mail_server CASCADE")
