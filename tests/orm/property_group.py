...
class test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assert_("UPDATE city SET name_de = 'Landeshauptstadt München' WHERE id = 2" in sqllog.queries)
        ...
        self.assert_("UPDATE city SET name_de = 'Domstadt Köln', name_en = 'City with a big Cathedral Cologne' WHERE id = 1" in sqllog.queries)
